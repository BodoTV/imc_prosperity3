...
class MarketMakingStrategy(Strategy):
    ...
    def act(self, state: TradingState) -> None:
        ...
        if default_price is not None:
            ...
            imbalance_influence = 1

            if order_book_imbalance > imbalance_threshold:
                max_buy_price += imbalance_influence  # Strong buy interest, bid more
            elif order_book_imbalance < -imbalance_threshold:
                min_sell_price -= imbalance_influence  # Strong sell interest, ask less
